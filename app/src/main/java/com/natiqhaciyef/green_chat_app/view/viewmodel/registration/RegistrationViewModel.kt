package com.natiqhaciyef.green_chat_app.view.viewmodel.registration
...
class RegistrationViewModel @Inject constructor(
    ...
    var dumsFromFirebase = MutableLiveData<List<DataUserModel>>(mutableListOf())
    ...
    fun send(email: String, content: () -> Unit) {
